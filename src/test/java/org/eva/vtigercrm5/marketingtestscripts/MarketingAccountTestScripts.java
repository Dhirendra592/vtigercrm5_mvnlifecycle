...
public class MarketingAccountTestScripts extends BaseTest {
	...
	public Object[][] fillUpBasicInfoProvider() {
		String[] strArray1 = { "9835737634", "pluse", "a telephonic", "man@gmail.com", "kaushambi", "utter pradesh",
				"212214", "India", "work while you work " };
		String[] strArray2 = { "6335737634", "circle", "marketing", "shiv@gmail.com", "meza", "utter pradesh", "212206",
				"India", "work while you work " };
		String[] strArray3 = { "8135737634", "tringle", " sales", "virendra@gmail.com", "bhadohi", "utter pradesh",
				"212244", "India", "work while you work " };
	...
	public void verifyVT001CreateAccount(String phone, String tickSymbole, String faxName, String email, String city,
			String state, String pinCode, String country, String description) throws InterruptedException {
		...
		String expAccountName = malp.fillUpBasicInformation(phone, tickSymbole, faxName, email, city, state, pinCode,
				country, description);
	...
	public void verifyVT005AccountEditable() {
		...
		if (!acNameBeforeEdit.equalsIgnoreCase(acNameAfterEdit)) { /// !...not equalsIgnoreCase
			System.out.println("Passed !,your Account name is editable because your before edit A/C name ="
					+ acNameBeforeEdit + " " + "and after edit A/C name =" + acNameAfterEdit + " is different");

		} else {
			System.out.println("Failed !,your Account name is editable because your before edit A/C name ="
					+ acNameBeforeEdit + " " + "and after edit A/C name =" + acNameAfterEdit + " is same");
		}
