...
public class WebUtil {
	...
	/**
	 *  driver :- it is the object of WebDriver that initialize at class
	 *  level or  variable.....
	 */
	 ...
	 * 
	 *   
	 *                         _ Created By User(public/private/default) without argument
	 *                        /
	 * # Default Constructors/
	 *                       \
	 *                        \_ Created By JVM(public) without argument
	 *                      
	 * 1.whenever we create a default constructor then we can create an Object
	 *   within the package.
	 * 2.whenever we create a public constructor then we can create an Object
	 *   anyWhere.
	 * 3.whenever we create a private constructor hen we can create an Object of that class
	 *   only within the class.                      
	 *   
	 * *InterViewer Question*
	 *  Ques:- Can we create an Object outside the class if our class is public
	 *         and constructor is private?   
	 *  Ans:- No! because when we create a constructor as a private then JVM won't
	 *        create a constructor it can only possible within the class  
	 *        
	 *                      
	 */
	private WebUtil() {
	...
	/**
	 * 1.private :- instance variable is private so it can't be accessed from outside.
	 * 2.static :- instance variable is static so object created only once and reused(shared) 
	 *             through getInstance() method.
	 * 1.Multiton class:-all the class that we create an object two or more
	 *                   times i.e called multiton class.
	 * 2.Singleton class:- singleton is a design pattern(architature).
	 *                   - A singleton class should have only one (Object)instance, 
	 *                    not more than one instance is created i.e called as singleton.                                         
	 */
	 ...
	 *                  will check the condition when WebUtil is null then it'll
	 *                  create an instance
	 *                  And it can be accessed from anywhere
	 *  a) create private constructor
	 *                             b) create public static method
	 *                             c) create private static variable of same class type
	 *                             d) Give condition as 
	 *                             if(webUtil==null) {
	 *		                          webUtil=new WebUtil();
	 *	                                 }
	 ...
	 * 
	 * @param screenShotfolderName :- we also pass the screen shot folder name in which
	 *                                we want to store the snapShot file in the form of png format.
	 */
	...
	public void takeSnapshotSingleElement(WebElement webObj,String screenShotfolderName){
		...
		try {
			...
			File destFile1=new File(""+screenShotfolderName+"\\sceernshot"+dateFormate1+".png");
	...
	/**
	 * takeSnapshotOfPage():- this method is commonally used to take 
	...
	public String takeSnapshotOfPage(String fileName) {
		...
		File destFile=new File("Snapshots\\"+fileName+currentTimeStamp+".png");
		try {
...
//Returns the absolute path of the file.
	...
	/**
	 * currentDateWithTime() :- this method is used to find the current date 
	 *                          with time in the format of dd-MMM-yyyy HH:mm:ss a.
	...
	/**
	 * currentDate() :- this method is also used to find the current date 
	 *                  with time in the format of dd-MMM-yyyy HH:mm:ss a.
	 *                  
	 * For example:- 10-04-2023 12:23:22 am Or pm
	 *                  
	 * @param dateFormat - we choose the date formate just like 12 Jan 2023 or 
	 *                     any format that you want to perform.
     *
	 * @return  - it will return the current date with time
	 *
	 */
	...
	/**
	 * @param yourString : it prints message in the console whatever you want to print
	 */
...
public void  statusAndDetails(Status status,String description) {
	...
	public  void thread(long duration)  {
		try {
			...
			statusAndDetails(Status.INFO, "we have given "+duration +" millies seconds to the element");
	...
	/**
	 * addCustomWindow:- this method is commonaly used to open custom window
	 *                   that you want by ChromeOptions() to use or
	 *                   add arguments with ChromeOptions....
	 *                   
	...
	public  ChromeOptions addToDisableInfobar() {
		...
		try {
			...
			statusAndDetails(Status.INFO, "chrome is being controlled by automated test software is removed Successfully");
			//	the above method remove this ---chrome is being controlled by automated test software	 
	...
	/**
	 * addMaximizedWindow:- this method is commonaly used to maximize to 
	 *                      the window by ChromeOptions() to use or
	 *                      add arguments with ChromeOptions....
	...
	/**
	 * addIncognitoMode :-this method is commonaly used to Incognito mode, 
	 *                    also known as private browsing or privacy mode
	 *                    In this mode, the browser does not save browsing history,
	 *                    cookies, site data, or form input
	 * @return :- this method returns the object of ChromeOptions class
	 */
	 ...
	 *                also known as "private browsing" or "incognito mode" in some browsers.
	 *                In this mode, the browser does not save browsing history,
	 *                cookies, site data, or form input
	 * @return  this method returns the object of ChromeOptions class
	 */
	...
	////////////   launchBrowser  \\\\\\\\\\
 	...
 	/**
 	 * launchBrowser():- this method is commonaly used to launch multi-choice browser
	 *                    just like chrome,firefox,edge and safari browser .  
	 *                    
 	 * @param browserName - choice the browserName in which you want to open 
 	 *                      your browser.
 	 */
 	public  void launchBrowser(String browserName) {
		try {
			...
			// This block will be executed if a SessionNotCreatedException occurs during the process
			...
			// Example: If the exception is due to incompatible Chrome and ChromeDriver versions
			...
			// Example: If the exception is due to any other issue with creating a WebDriver session
		...
		windowMaximize();
		implicitilyOfSeconds(30);

	}
	////////////   windowMaximize  \\\\\\\\\\

	/**
	 * with the help of this method we can maximize 
	 * our window ....
	 */
...
//			statusAndDetails(Status.INFO, "the window is not maximized");
	...
	/**
	 * with the help of this method we can minimize 
	 * our window ....
	 */
	...
	/**
	 * myIplicitilyWait() -- with the help of this method we can wait as per given duration to
	 *                       the element until we get the element ,if we don't get the element
	 *                       as per given duration then we don't wait..
	 *                       but if we get the element under given duration then after that
	 *                       we donn't wait...
	 *                       this type of wait is known as dynamic wait....
	 *                      
	...
	/**
	 * @return it returns the source code of the current page in the 
	 *         form of HTML.
	 */
	...
	/**
	 * In Selenium WebDriver, the myClose() method is used to close the current browser
	 * window or tab that the WebDriver instance is currently focused on. 
	 * It does not quit the entire browser session, meaning if you have
	 * opened multiple windows or tabs using the WebDriver, only the currently
	 * active window/tab will be closed.
	 * 
	 */
	public  void myClose() {
	...
	/**
	 * In Selenium WebDriver, the myQuit() method is used to completely close
	 * all browser windows and end the WebDriver session. 
	 * It is the recommended method to use when you want to clean up and close
	 * the WebDriver instance along with all associated browser windows or tabs.
	 * 
	 */
	public  void quit() {
	 ...
	 * switch the current window to another window with the help of it's title 
	 * that we want to switch the window... 
	 * 
	 * @param expectPageTitle 
	 *        this expectedPageTitle is in the form of String. it means in which window
	 *        we want to switch the window from current window that webdriver instance is currently 
	 *        focoused on.
	 */
	 ...
	 * switch the current window to another window with the help of it's url 
	 * that we want to switch the window... 
	 * 
	 * @param expectPageUrl
	 *        this expectPageUrl is in the form of String. it means in which window
	 *        we want to switch the window from current window that webdriver instance is currently 
	 *        focoused on.
	 */
	 ...
	 * again and again to refress the page .this type of tilte is called dynamic title.
	 * 
	 * @param dynamicTitle
	 *        we give our expected pageTitle in which we want to switch from the current window or tab
	 *        that contain some common title to refress the page..
	 *        
	 */
	public  void switchToWindowByDynamicTitle(String dynamicTitle) {
		...
		try {
			...
			statusAndResult(Status.INFO, "the Window is switched by dynamic  title :- "+dynamicTitle+" successfully");
		}catch(NoSuchWindowException e) {
			e.printStackTrace();
			statusAndResult(Status.INFO, "the Window is not switched bydynamic  title :- "+dynamicTitle+" successfully");
			throw e;
		}catch(Exception e) {
			e.printStackTrace();
			statusAndResult(Status.INFO, "the Window is not switched by dynamic title :- "+dynamicTitle+" successfully");
			throw e;
		}
	}
	 ...
	 * 
	 * @param dynamicUrl
	 *        we give our expected pageUrl in which we want to switch from the current window or tab
	 *        that contain some common url to refress the page..
	 *        
	 */
	public  void switchToWindowByDynamicUrl(String dynamicUrl) {
		...
		try {
			...
			e.printStackTrace();
			statusAndResult(Status.INFO, "the Window is not switched by dynamic url :- "+dynamicUrl+" successfully");
			throw e;
		}catch(Exception e) {
			e.printStackTrace();
			statusAndResult(Status.INFO, "the Window is not switched by dynamic url :- "+dynamicUrl+" successfully");
	...
	/**
	 * switchToFrameByWebElement() :-this  method is used to enter in the frame with the help of
	 *                               WebElement of the frame  from the current browser window or tab 
	 *                               that the WebDriver instance is currently focused on.
	 * @param webObj :- it requires the object of WebElement in the form of arguments
	 *                  to switching the frame
	 *                  
	 */
	...
	/**
	 * switchToFrameByIndex() :-this  method is also used to enter in the frame with the help of
	 *                          index of the frame from the current browser window or tab 
	 *                          that the WebDriver instance is currently focused on.
	 *                               
	 * @param frameIndex  In here we give frame's index to enter in frame
	 * 
	 * @param elementName  elementName is mostly used to locate in which frame element we are entering
	 *                     and give the proper message in the console
	 *                     
	 */
	...
	/**
	 * switchToFrameByNameOrId() :-this  method is also used to enter in the frame with the help of
	 *                          name or id (locator) of the frame from the current browser window or tab 
	 *                          that the WebDriver instance is currently focused on.
	 *                               
	 * @param NameOrId  In here we give frame's name and id as a locator to enter in frame
	 * 
	 */
	 ...
	 * field by java script. if the element is hidden in UI then finally we 
	 * can use java script....
	 *  
	...
	public  void myJsSendKeys(WebElement webObj, String inputValue) {
		...
		try {
			...
			statusAndResult(Status.INFO, inputValue+" value has entered in "+elementName+" in textbox by java script successfully");

		}catch(Exception e) {
			e.printStackTrace();
			statusAndResult(Status.INFO, inputValue+" value hasn't entered in "+elementName+" in textbox by java script successfully");
			throw e;
		}
...
clear(webObj);
		...
		if(webObj.isDisplayed() && webObj.isEnabled()) {
			...
			try {
				...
				statusAndResult(Status.INFO, inputValue+" value is passed in "+elementName+" textbox successfully");
				...
				JavascriptExecutor jse=(JavascriptExecutor)driver;
				jse.executeScript("arguments[0].value='"+inputValue+"'",webObj );
				statusAndResult(Status.INFO, inputValue+" value has entered in "+elementName+" textbox successfully");
			}catch(StaleElementReferenceException e) {
				...
				e.printStackTrace();
				statusAndResult(Status.INFO, inputValue+" value hasn't entered in "+elementName+" textbox successfully");
				throw e;
			}
	 ...
	 * 
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to get attribute value
	 *        
	 * @param attributeName
	...
	public  String getAttributeValue(WebElement webObj, String attributeName) throws ElementClickInterceptedException {
		...
		if(webObj.isDisplayed() && webObj.isEnabled()) {
			...
			try {
				...
				statusAndResult(Status.INFO, attributeName+" Attribute value of "+elementName+" :-"+attributeValue+" is found successfully ");
			}catch(ElementNotInteractableException e) {
				...
				e.printStackTrace();
				statusAndResult(Status.INFO, attributeName+" Attribute value of "+elementName+" :-"+attributeValue+" is not found successfully ");
				throw e;
			}
	 ...
	 * 
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to clear the data in 
	 *                  the input box or input field.
	 */
	...
	/**
	 * The myJSClick() method is commonly used to click any element 
	 * whether element is hidden or not. it's doesn't matter because 
	 * JS perform action with the html code directly. 
	 * 
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to click the element
	 *                  by java script. 
	 */
	 ...
	 * 
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to click as a normal.
	 */
	 ...
	 * 
	 * @param listObj
	 *        it requires the object of list of WebElement as a parameter to
	 *        find out the element where you want to check all the check boxes.
	 */
	 ...
	 * @param listObj
	 *        it requires the object of list of WebElement as a parameter to
	 *        find out the element where you want to uncheck all the check boxes.
	 */
	 ...
	 *
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to get inner text of the element.
	 * 
	 ...
	 * 
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to get offset of x-axis 
	 *                  and y-axis of the element.
	 * 
	 * @return
	 ...
	 * 
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to get hight and
	...
	/**
	 * verifyInnerText() :- this method is used to verify the innner text 
	 *                      of actual and expected value of the element.  
	 * 
...
//   }
	...
	public void verifyAttributeValue(WebElement we, String attributeName ,String expectedAttribute) {
		...
		if (actualAttribute.equalsIgnoreCase(expectedAttribute)) {
			webUtil.statusAndResult(Status.PASS, "Passed. Actual-"+actualAttribute+" && Expected-"+expectedAttribute);
		} else {
			webUtil.statusAndResult(Status.FAIL, "Failed. Actual-"+actualAttribute+" && Expected-"+expectedAttribute);
		}
...
//verifyDropdownValue
	...
	public  void verifyInt(int actInt,int expInt) {
		...
		if(actInt==expInt) {
			statusAndResult(Status.PASS, "the actual integer :-"+actInt+" and expected integer :-"+expInt+" both are same");
		}else {
			statusAndResult(Status.FAIL, "the actual integer :-"+actInt+" and expected integer :-"+expInt+" both are not same");
		}
	 ...
	 * 
	 * @param actualString
	 *        it refers to the actual String.
	 *        
	 * @param expectedString
	 *        it refers to the expected String.
	 */
	public  void verifyText(String actualString,String expectedString,String message) {
		if(actualString.equalsIgnoreCase(expectedString)) {
			statusAndResult(Status.PASS, "the actual :-"+actualString+" && expected :-"+expectedString+" both are same");
		}else {
			statusAndResult(Status.FAIL, "the actual :-"+actualString+" && expected :-"+expectedString+" both are not same");
		}
	 ...
	 * 
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to check the 
	 ...
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to check the 
	 *                  element is selected or not in the drop down. 
	 * @return
	 *        it returns boolean i.e true or false
	 *        
	 */
	public  boolean checkSelected(WebElement webObj) {
		...
		if(webObj.isDisplayed() && webObj.isEnabled()) {
			...
			try {
				...
				statusAndResult(Status.INFO, "textBox or radio button or option in select dropDown is selected successfilly");
			}catch (ElementNotInteractableException e) {
				...
				e.printStackTrace();
				statusAndResult(Status.INFO, "textBox or radio button or option in select dropDown is not selected successfilly");
	...
	public  void selectByIndexNumber(WebElement webObj,int indexNumber) {
		...
		if(webObj.isDisplayed() && webObj.isEnabled()) {
			...
			try {
				...
				statusAndResult(Status.INFO, "you have selected the element in dropDown by it's index number :--"+indexNumber);
			}catch(ElementNotInteractableException eo) {
				...
				e.printStackTrace();
				statusAndResult(Status.INFO, "you haven't selected the element in dropDown by it's index number :--"+indexNumber);
				throw e;
	 ...
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to select the element
	 *                  in the drop down by using text of the element.
	 * 
	 * @param visibleString
	...
	public  void selectByVisibleString(WebElement webObj,String visibleString) {
		...
		if(webObj.isDisplayed() && webObj.isEnabled()) {
			...
			try {
				...
				statusAndResult(Status.INFO, "you have selected the element in dropDown by it's visible String :--"+visibleString);
			}catch(StaleElementReferenceException e) {
				slct.selectByVisibleText(visibleString);
				statusAndResult(Status.INFO, "you have selected the element in dropDown by it's visible String :--"+visibleString);
			}
				...
				e.printStackTrace();
				statusAndResult(Status.INFO, "you haven't selected the element in dropDown by it's visible String :--"+visibleString);
				throw e;
			}
	...
	public  String getFirstSelectedElement(WebElement webObj) {
		...
		try {
			...
			statusAndResult(Status.INFO, "Fetch the first selected element :- "+firstSelected+" of "+elementName+" dropDown  successfully");
		}catch(StaleElementReferenceException e) {
			firstSelected=slt.getFirstSelectedOption().getText();
			statusAndResult(Status.INFO, "Fetch the first selected element :- "+firstSelected+" of "+elementName+" dropDown  successfully");
		}catch(ElementNotInteractableException e) {
			...
			e.printStackTrace();
			statusAndResult(Status.INFO, "Didn't Fetch the first selected element :- "+firstSelected+" of "+elementName+" dropDown successfully");
		}
		return firstSelected;
	}
	 ...
	 * 
	 * @param webObj :- it requires the object of list of WebElement as a parameter to
	 *                  find out the element where you want to get all the elements
	 *                  in the drop down.
	 *  
	 */
	 ...
	 * 
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to get the numbers of the elements
	 *                  in the drop down.
	 *        
	 ...
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to click the element
	 *                  with the help of Actions's click method.
	 * 
	 */
	 ...
	 * 
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to right click of the element
	 ...
	 * 
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to double click of the element
	 ...
	 * 
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to send the value
	 *                  in input box or input field with the help of Actions's sendKeys method.
	 *        
	 * @param inputValue
	 ...
	 * 
	 * @param webObj :- it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to scroll the cursor
	 *                  at the element with the help of Actions's scrollToElement method.
	 */
	public  void scrollingToElement(WebElement webObj) {
		...
		if(webObj.isDisplayed() && webObj.isEnabled()) {
			...
			try {
				...
				e.printStackTrace();
				statusAndResult(Status.INFO, "scrolling to the element is not performed successfully by Actions method");
				throw e;
			}
		}else {
			statusAndResult(Status.INFO, "Element is not displayed and Enabled");
	...
	/**
	 * 
	 * mouseDragDrop(WebElement dragWeb,WebElement dropWeb) :- this method is especially designed to 
	 *                                                         drag and drop operation from one webElement to
	 *                                                         another webElement
	 *                     
	 * @param dragWeb :-it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to drag at the element
	 *                  with the help of Actions's dragAndDrop method.
	 * 
	 * @param dropWeb :-it requires the object of WebElement as a parameter to
	 *                  find out the element where you want to drop at the element
	 *                  with the help of Actions's dragAndDrop method.
	 */
	public  void mouseDragDrop(WebElement dragWeb,WebElement dropWeb) {
		...
		if (dragWeb.isDisplayed() &&dropWeb.isEnabled() && dropWeb.isDisplayed() &&dropWeb.isEnabled()) {
			statusAndResult(Status.INFO, "Both element "+dragElementName+" and "+dropElementName +"is disable and enable");
			try {
				ac.dragAndDrop(dragWeb, dropWeb).build().perform();
				statusAndResult(Status.INFO, "Drag operation "+dragElementName +" is  droped to the "+dropElementName+" successfully");
			}catch (StaleElementReferenceException e) {
				ac.dragAndDrop(dragWeb, dropWeb).build().perform();
				statusAndResult(Status.INFO, "Drag operation "+dragElementName +" is  droped to the "+dropElementName+" successfully");
			}catch (ElementNotInteractableException e) {
				...
				js.executeScript("function simulate(f,c,d,e){var b,a=null;"
						...
						dragWeb,xto,yto);
				statusAndResult(Status.INFO, "Drag operation "+dragElementName +" is not droped to the "+dropElementName+" successfully");
			}catch (Exception e) {
				e.printStackTrace();
				statusAndResult(Status.INFO, "Drag operation "+dragElementName +" is not droped to the "+dropElementName+" successfully");
				throw e;
			...
			statusAndResult(Status.INFO, "Both element "+dragElementName+" and "+dropElementName +"is not disable and enable");
		}
	}
	...
	/**
	 * mouseClickAndHold(WebElement webObj) :- this method is used to click and hold of that element with the help of 
	 * mouse it means that pressing the left button on an element without releasing
	 * it.This method is often used in combination with other Actions methods to 
	 * perform complex interactions like drag-and-drop.
	 * 
	 * @param webObj :-it requires the object of WebElement as a parameter to
	 *                 find out the element where you want to click and hold to the element
	 ...
	 * 
	 * @param webObj :-it requires the object of WebElement as a parameter to
	 *                 find out the element where you want to release to the element
	 *                 with the help of Actions's release method.
	 */
	 ...
	 * 
	 * @param webObj :-it requires the object of WebElement as a parameter to
	 *                 find out the element where you want to move to the element
	 *                 with the help of Actions's moveToElement method.  
	 */
